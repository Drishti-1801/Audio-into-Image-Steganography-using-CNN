...
x_train = tf.image.resize(x_train, [24, 24]).numpy()     # resize to 24×24
print(" Images:", x_train.shape)


# 2️ Generate Synthetic Audio Data (Sine Waves)
...
# 3️ Define Base CNN Block (as custom Layer)
...
# 4️ Build Prepare, Hiding, and Reveal Networks
...
# 5️ Combine Full Model (end-to-end)
...
print(f"\n MSE (Image): {mse_image:.6f}")
print(f" Correlation (Audio): {corr_audio:.4f}")
